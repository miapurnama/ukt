<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Hapus Parameter</h1>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        ?>
                                        <form action="pemroses/hapusparameter.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id_parameter" value="<?php echo $row['id_parameter']; ?>" readonly>
                                        <div class="form-group">
                                            <label>Kode Kriteria</label>
                                            <input type="text" name="kode_kriteria" class="form-control" value="<?php echo $row['kode_kriteria']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Parameter/ Interval</label>
                                            <textarea class="form-control" name="interval" rows="8" placeholder="Masukkan Nama/interval parameter" readonly><?php echo $row['interval_parameter']; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Skor</label>
